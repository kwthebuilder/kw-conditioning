...
3. `spec/engine_test_vectors_v1.json` is the acceptance contract. Where prose and vectors disagree, the vectors win and the disagreement goes in `SPEC_QUESTIONS.md`.
